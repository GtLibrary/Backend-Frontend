...
class Books(models.Model):
    ...
    book_price = models.DecimalField(max_digits = 7,decimal_places=3)
    bookmark_price = models.DecimalField(max_digits = 7,decimal_places=3)
    hardbound = models.CharField(max_length=200, default='')
    hardbound_from = models.CharField(max_length=200, default='')
    hardbound_price = models.DecimalField(max_digits = 7,decimal_places=3)
